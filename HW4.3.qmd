...
```{r}
#| label: airports-data-and-vizualization
#| echo: false
#| warning: false
#| message: false
#| tbl-cap: "Passenger Traffic at Six Major International Airports (millions, 2020–2024)"
#| fig-cap: "Line chart showing passenger traffic recovery at six major international airports from 2020 to 2024."
#| fig-alt: "Line chart with one colored line per airport showing passenger counts in millions from 2020 to 2024. Atlanta leads throughout. Dubai shows the steepest recovery."
...
```{r}
#| label: monte-carlo-combined
#| echo: false
#| warning: false
#| message: false
#| fig-cap: "Monte Carlo integration of the Weibull PDF at four sample sizes displayed as a 2x2 grid."
#| fig-alt: "Four scatterplots arranged in a 2x2 grid showing Monte Carlo integration estimates at n = 10, 100, 1000, and 10000. Green points fall below the Weibull curve and red points fall above. Estimates converge toward 1.0 as sample size increases."
...
```{r}
#| label: monte-carlo-small-multiples
#| echo: false
#| warning: false
#| message: false
#| fig-cap: "Small multiple visualization of Monte Carlo integration across four sample sizes."
#| fig-alt: "Four scatterplots in a 2x2 grid showing Monte Carlo estimates of the Weibull PDF integral at n = 10, 100, 1000, and 10000. Visual density of points increases with sample size and estimates converge toward 1.0."
...
#| warning: false
#| message: false
#| fig-cap: "Ulnar calcium levels measured at four time points for control and diet/exercise groups."
#| fig-alt: "Line chart showing ulnar calcium levels over four time points for 31 women. Faint lines show individual subjects and bold lines show group means. The diet and exercise group trends slightly higher through Year 2 before declining."
...
```{r}
#| label: genai-plan-based-response
#| eval: false
#| echo: true
